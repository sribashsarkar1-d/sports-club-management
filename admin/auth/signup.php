...
<head>
    ...
    <title>Create Admin — Sports Management System</title>
    ...
    <div class="auth-panel auth-panel--brand">
        ...
        <div class="brand-middle">
            <div class="brand-badge">
                ...
                <span class="brand-badge-text">Admin Registration</span>
            </div>

            <div class="brand-headline">
                <h1>
                    JOIN THE
                    <span class="accent">ELITE</span>
                    TEAM
                </h1>
                <div class="brand-divider"></div>
                <p>
                    Create your administrator account to start managing athletes,
    ...
    <div class="auth-panel auth-panel--form">
        ...
        <div class="form-container">
            ...
            <div class="form-header">
                <span class="form-badge">New Admin</span>
                <h2>Create Account</h2>
                <p>Set up your administrator credentials to access the management dashboard.</p>
            </div>

            <!-- Signup Form — logic unchanged -->
            <form action="signup-action.php" method="POST" novalidate>
                ...
                <div class="auth-form-group">
                    ...
                    <div class="input-wrapper">
                        <input
                            ...
                            required>
                        <button type="button" class="input-eye-btn" onclick="togglePassword('signup-password', this)" aria-label="Toggle password visibility">
                ...
                <button type="submit" name="create_admin" class="btn-auth-submit">
